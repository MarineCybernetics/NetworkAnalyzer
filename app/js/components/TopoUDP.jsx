...
var TopoUDP = React.createClass({
  ...
  render: function() {
    ...
    var udpmsList = <g className="udpms"/>;
    ...
    if (nodes !== undefined) {
      ...
      udpmsList = nodes.map(function(one, index) {
        var udpmList = <g className="udpms"/>;
