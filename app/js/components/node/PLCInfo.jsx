...
var PLCInfo = React.createClass({
  ...
  render: function() {
    ...
    var linkmeaspathName = "plclinkmeas" + match;
        ...
        <div className="modal fade in" style={{display: "block"}} tabIndex="-1" role="dialog">
          <div className="modal-dialog thruster-info"  onClick={this._onModalDialogClick}>
            <div className="modal-content">
              <Header title="PLC" name={nodeId} tabIndex="1" backPath={backPath}/>
              <div className="modal-body">
                ...
                <Metadata title="PLC" stype={this.state.stype} Vendor={this.state.Vendor} Desc={this.state.Desc} />
                <RouteHandler />
              </div>
            </div>
          </div>
