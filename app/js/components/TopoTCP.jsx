  ...
  render: function() {
    ...
    if (channels !== undefined) {
        channelsList = channels.map(function(one, index) {
          $('[data-toggle="popover"]').popover();
          return(
            <line tapId={tapId} key={index} id={one.id} x1={one.x1} y1={one.y1} x2={one.x2} y2={one.y2} style={{"stroke":"rgb(0,0,255)","strokeWidth":"2","cursor":"pointer", "fontSize":"100"}} data-trigger="click focus" data-template='<div class="popover">
